...
var pathToImages = '/include/js/dhtml_calendar/images/';	// Relative to your HTML file
			...
			for(var i=0;i<elements.length;i++) {
				if(positionArray[elements[i]]>=0) {
                    if(properties[i] == 'currentMonth') {
					    window[properties[i]] = inputField.value.substr(positionArray[elements[i]],propertyLength[i])/1 - 1;
                    } else {
