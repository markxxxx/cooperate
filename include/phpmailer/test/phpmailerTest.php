...
From Address: <input type="text" size="50" name="mail_from" value="<?php declare(strict_types=1) echo get("mail_from"); ?>"/>
<br/>
To Address: <input type="text" size="50" name="mail_to" value="<?php declare(strict_types=1) echo get("mail_to"); ?>"/>
<br/>
Cc Address: <input type="text" size="50" name="mail_cc" value="<?php declare(strict_types=1) echo get("mail_cc"); ?>"/>
<br/>
SMTP Hostname: <input type="text" size="50" name="mail_host" value="<?php declare(strict_types=1) echo get("mail_host"); ?>"/>
<p/>
