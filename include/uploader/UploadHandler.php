...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/media/attachments/',
            'upload_url' => $this->get_full_url().'/media/attachments/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($uploaded_file && is_uploaded_file($uploaded_file)) {
                ...
                if ($append_file) {
                    ...
                    $attachment_id = $attachment->auto_inc();
                    $attachment->filename = $file->name;

                    $attachment->insert();

                    Attachment::add_attachment($attachment->id);
