...
*
* $this->_image()->resize('car.jpg', 500, 500);
*
...
*
* $this->_image()->resize('car.jpg', 500, 500, 'tb_car.jpg');
*
...
* Cut 800x600 image:
*
* $this->_image()->crop('car.jpg', 500, 500);
*
...
*
* $this->_image()->crop('car.jpg', 500, 500, 'tb_car.jpg');
*
...
*
* $this->_image()->flipflop('car.jpg', 'flip', 'tb_car.jpg');
*
* The result is a new image with vertical flip
*
* $this->_image()->flipflop('car.jpg', 'flop', 'tb_car.jpg');
*
* The result is a new image with horizontal flop
*
* $this->_image()->flipflop('car.jpg', 'flipflop', 'tb_car.jpg');
*
...
*
* $this->_image()->gray('car.jpg', 'tb_car.jpg');
*
...
*
* $this->_image()->quality('car.jpg', 70);
*
* ----------------------------------------------------------------
*/
...
//	var $cache = 'cache/'; // Cache folder
	...
	*/
    ...
    public function is_image($src) {
        return $this->itsImage($src);
    }
    
    function find_in_dom($html) {
    $images = array();
