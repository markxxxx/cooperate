                ...
                <div class="page-header page-header-default">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><!-- <i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> -  -->Report: Snags Per Project</h4>
                        </div>
...
<!--                                     <a href="#" class="btn bg-teal-400 legitRipple btn-default btn-sm" data-toggle="modal" data-target="#modal_iconified">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="/report/snagsperproject" method="POST" accept-charset="utf-8" id="form_date_filter">
                                    ...
                                    {if $snags}   
                                        <table class="table datatable-basic dataTable">
                                            ...
                                            {section name=inst loop=$snags}   
                                                <tr>
                                                    <td>{$snags[inst].customer_name}</td>
                                                    <td>{$snags[inst].customer_surname}</td>
                                                    <td>{$snags[inst].customer_company}</td>
                                                    <td>{$snags[inst].project_name}</td>
                                                    <td>{$snags[inst].snag_count}</td>   
