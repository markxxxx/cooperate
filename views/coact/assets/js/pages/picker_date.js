...
$(function() {
    ...
    $('.daterange-single-submit').daterangepicker({
        singleDatePicker: true,
        locale: {
            format: 'YYYY-MM-DD'
        },
    ...
    $('#ButtonStartDate').click(function (e) {
        $('#ButtonStartDateInput').AnyTime_noPicker().AnyTime_picker().focus();
        e.preventDefault();
    });
     $('#ButtonEndDate').click(function (e) {
        $('#ButtonEndDateInput').AnyTime_noPicker().AnyTime_picker().focus();
        e.preventDefault();
    });

    $('#departureButton').click(function (e) {
        $('#departureInput').AnyTime_noPicker().AnyTime_picker().focus();
        e.preventDefault();
    });

    $('#arrivalButton').click(function (e) {
        $('#arrivalInput').AnyTime_noPicker().AnyTime_picker().focus();
        e.preventDefault();
    });
    //
    // Date range
