                ...
                <div class="page-header page-header-default">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><!-- <i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> -  -->Team Appointments</h4>
                        </div>
                    ...
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Team Appointments</li>
                        </ul>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                 <div class="col-lg-2">
                                    ...
                                    <table class="table datatable-basic dataTable">
                                        ...
                                        {section name=inst loop=$projects}
                                            <tr><td style="background-color:{$projects[inst].color}">{$projects[inst].name}</td></tr>                                    
                                        {/section}  
                                        </tbody>
                                    </table>
                                ...
                                <div class="col-lg-10">
									...
									{if $appointments}	
									<table class="table datatable-basic dataTable" style="border-spacing: 1px;">
										<thead>
											<tr>
												<th>Date</th>

                                                {section name=inst loop=$teams}
												    <th>{$teams[inst].name|ucfirst}</th>
                                                {/section}
										...
										<tbody>
                                        {section name=inst2 loop=$dates}
                                            <tr>
                                                <td>{$dates[inst2].date}</td>

                                                {section name=inst3 loop=$teams}
    										      {section name=inst4 loop=$appointmentRange}	                                                  

                                                    {if $appointmentRange[inst4].start_date eq $dates[inst2].date && $appointmentRange[inst4].group_id eq $teams[inst3].id }
    												    <td>
                                                            <div style="background-color:{$appointmentRange[inst4].color} ">{$appointmentRange[inst4].task_name}</div>
                                                            
                                                            {if $appointmentRange[inst4+1].start_date eq $dates[inst2].date && $appointmentRange[inst4+1].group_id eq $teams[inst3].id }
                                                            <div style="background-color:{$appointmentRange[inst4].color} ">{$appointmentRange[inst4].task_name}</div>
                                                            {/if}
