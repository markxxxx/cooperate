                ...
                <div class="page-header page-header-default">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><!-- <i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - --> Handle Size Manager</h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            ...
                            <ul class="icons-list">
                            		<a href="#" class="btn bg-teal-400 legitRipple btn-default btn-sm" data-toggle="modal" data-target="#modal_iconified">
                            			<i class="icon-statistics position-left"></i> Add New Handle Size</a>                            		
                    			</ul>
                            <div class="heading-elements">
                                ...
                                <div class="col-lg-12">
									...
									{if $handlesizes}	
										<table class="table datatable-basic table-hover">
											...
											<tbody>
											{section name=inst loop=$handlesizes}	
												<tr>
													<td>{$handlesizes[inst].id}</td>
													<td>{$handlesizes[inst].handlesize_name}</td>
													<td style="display: none"></td>
													<td style="display: none"></td>
													<td style="display: none"></td>
													<td class="text-center">
														{if $user->can_access('handlesize', 'delete')}
														<ul class="icons-list">
															<li class="dropdown">
																<a href="#" class="dropdown-toggle" data-toggle="dropdown">
																...
																<ul class="dropdown-menu dropdown-menu-right">
																	<!-- <li><a href="handlesize/add/{$handlesizes[inst].id}"><i class="icon-database-edit2"></i> Edit</a></li> -->
																	<!-- <li><a href="#"><i class="icon-user-check"></i> Login As this user</a></li> -->
																	<li><a href="/setup/handlesize_delete/{$handlesizes[inst].id}" onclick="return confirm('Are you sure you want to Remove?');"><i class="icon-database-remove"></i> Delete</a></li>
																</ul>
															</li>
														</ul>
														{/if}
			            ...
			            <div class="modal-dialog">
			              <div class="modal-content">
			                <div class="modal-header">
			                  ...
			                  <h5 class="modal-title"><i class="icon-menu7"></i> &nbsp;{if $data.id|default:0 eq 0}Create a new{else}Update current{/if} handlesize</h5>
			                </div>

			                <div class="modal-body">
			                  <div class="alert alert-info alert-styled-left text-blue-800 content-group">
			                            <span class="text-semibold">Yay!</span> more handlesizes.
			                 ...
			                 <form action="/setup/handlesize_add/{$data.id|default:0}" method="post" name="form_handlesize" enctype="multipart/form-data" class="middle-forms" id="form_handlesize">
								<fieldset>
									<ol style="list-style: none;">
										
										<li>
											<!-- <span class="label bg-teal help-inline">Email address</span> -->
											<input name="data[handlesize_name]" type="text" class="form-control" id="field_handlesize_name" value="{$data.handlesize_name}" placeholder="Name or Value" required/>
											{error field=handlesize_name}
