        ...
        <div class="content">
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="modal-title"><i class="icon-menu7"></i> &nbsp;{if $data.id|default:0 eq 0}Create a new{else}Update current{/if} Task</h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                            ...
                            <form action="/task/add/{$data.id|default:0}" method="post" name="form_task" enctype="multipart/form-data" class="middle-forms" id="form_task">
                                <fieldset>
                                    <ol style="list-style: none;">
                                        ...
                                        <li>&nbsp;</li>
                                        <li>
                                            <span class="label bg-teal help-inline">Class Selection</span>
                                ...
                                <div class="modal-footer">
                                    <a class="btn btn-link" href="/task"><i class="icon-cross"></i> Close</a>
