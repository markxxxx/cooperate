                        ...
                        <div class="panel-heading">
                            ...
                            <ul class="icons-list">
                            		<a href="#" class="btn bg-teal-400 legitRipple btn-default btn-sm" data-toggle="modal" data-target="#modal_iconified">
                            			<i class="icon-statistics position-left"></i> Add New Accessory</a>                            		
                    			</ul>
                            <div class="heading-elements">
									...
									{if $accessories}	
										<table class="table datatable-basic table-hover">
											...
											{section name=inst loop=$accessories}	
												<tr>
													<td>{$accessories[inst].id}</td>
													<td>{$accessories[inst].name}</td>
													<td>{$accessories[inst].description}</td>
													<td style="display: none"></td>
                                                    <td style="display: none"></td>
													<td class="text-center">
														{if $user->can_access('accessory', 'delete')}
														<ul class="icons-list">
															<li class="dropdown">
																<a href="#" class="dropdown-toggle" data-toggle="dropdown">
																...
																<ul class="dropdown-menu dropdown-menu-right">
																	<!--<li><a href="/setup/accessory/add/{$accessories[inst].id}"><i class="icon-database-edit2"></i> Edit</a></li>-->
																	<!--<li><a href="#"><i class="icon-user-check"></i> Login As this user</a></li> -->
																	<li><a href="/setup/accessory_delete/{$accessories[inst].id}" onclick="return confirm('Are you sure you want to Remove?');"><i class="icon-database-remove"></i> Delete</a></li>
																</ul>
															</li>
														</ul>
														{/if}
			              ...
			              <div class="modal-content">
			                ...
			                <div class="modal-body">
			                  <div class="alert alert-info alert-styled-left text-blue-800 content-group">
			                            <span class="text-semibold">Yay!</span> more accessories.
			                 ...
			                 <form action="/setup/accessory_add/{$data.id|default:0}" method="post" name="form_accessory" enctype="multipart/form-data" class="middle-forms" id="form_accessory">
								<fieldset>
									<ol style="list-style: none;">
										...
										<li>
											<!-- <span class="label bg-teal help-inline">accessory First Name</span> -->
