                ...
                <div class="page-header page-header-default">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><!-- <i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - --> Top Thickness Manager</h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            ...
                            <ul class="icons-list">
                            		<a href="#" class="btn bg-teal-400 legitRipple btn-default btn-sm" data-toggle="modal" data-target="#modal_iconified">
                            			<i class="icon-statistics position-left"></i> Add New Top Thickness</a>                            		
                    			</ul>
                            <div class="heading-elements">
                                ...
                                <div class="col-lg-12">
									...
									{if $topthicknesses}	
										<table class="table datatable-basic table-hover">
											...
											<tbody>
											{section name=inst loop=$topthicknesses}	
												<tr>
													<td>{$topthicknesses[inst].id}</td>
													<td>{$topthicknesses[inst].topthickness_name}</td>
													<td style="display: none"></td>
													<td style="display: none"></td>
													<td style="display: none"></td>
													<td class="text-center">
														{if $user->can_access('topthickness', 'delete')}
														<ul class="icons-list">
															<li class="dropdown">
																<a href="#" class="dropdown-toggle" data-toggle="dropdown">
																...
																<ul class="dropdown-menu dropdown-menu-right">
																	<!-- <li><a href="topthickness/add/{$topthicknesses[inst].id}"><i class="icon-database-edit2"></i> Edit</a></li> -->
																	<!-- <li><a href="#"><i class="icon-user-check"></i> Login As this user</a></li> -->
																	<li><a href="/setup/topthickness_delete/{$topthicknesses[inst].id}" onclick="return confirm('Are you sure you want to Remove?');"><i class="icon-database-remove"></i> Delete</a></li>
																</ul>
															</li>
														</ul>
														{/if}
			            ...
			            <div class="modal-dialog">
			              <div class="modal-content">
			                <div class="modal-header">
			                  ...
			                  <h5 class="modal-title"><i class="icon-menu7"></i> &nbsp;{if $data.id|default:0 eq 0}Create a new{else}Update current{/if} topthickness</h5>
			                </div>

			                <div class="modal-body">
			                  <div class="alert alert-info alert-styled-left text-blue-800 content-group">
			                            <span class="text-semibold">Yay!</span> more topthicknesses.
			                 ...
			                 <form action="/setup/topthickness_add/{$data.id|default:0}" method="post" name="form_topthickness" enctype="multipart/form-data" class="middle-forms" id="form_topthickness">
								<fieldset>
									<ol style="list-style: none;">
										
										<li>
											<!-- <span class="label bg-teal help-inline">Email address</span> -->
											<input name="data[topthickness_name]" type="text" class="form-control" id="field_topthickness_name" value="{$data.topthickness_name}" placeholder="Name" required/>
											{error field=topthickness_name}
