                ...
                <div class="page-header page-header-default">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><!-- <i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> -  -->Report: Invoiced Vs Freebies</h4>
                        </div>
...
<!--                                     <a href="#" class="btn bg-teal-400 legitRipple btn-default btn-sm" data-toggle="modal" data-target="#modal_iconified">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="/report/jobsvsfreebies" method="POST" accept-charset="utf-8" id="form_date_filter">
                                        ...
                                        <table class="table datatable-basic dataTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>No. of freebies</th>
                                                    <th>No. of Invoiced</th>
                                            ...
                                            <tbody>
                                            {section name=inst loop=$freebies}   
                                                <tr>
                                                    <td style="display: none;">{$freebies[inst].project_name}</td>
                                                    <td>{$freebies[inst].freebies}</td>
                                                    <td>{$invoiced[inst].invoiced}</td> 
